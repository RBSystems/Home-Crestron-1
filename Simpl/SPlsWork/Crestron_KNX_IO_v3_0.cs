...
namespace UserModule_CRESTRON_KNX_IO_V3_0
{
    public class UserModuleClass_CRESTRON_KNX_IO_V3_0 : SplusObject
    {
...
public UserModuleClass_CRESTRON_KNX_IO_V3_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
